...
#ifndef curecoin_WALLET_H
#define curecoin_WALLET_H
...
public:
    ...
    bool LoadWatchOnly(const CTxDestination &dest) { return CCryptoKeyStore::AddWatchOnly(dest); }
    ...
    // Custom function to create and send a Research Core registration TX
    std::string SendRegistrationTx(const std::string& username, std::string& strError);
...
public:
    ...
    COutput(const CWalletTx *txIn, int iIn, int nDepthIn, bool fSpendableIn = true)
    {
